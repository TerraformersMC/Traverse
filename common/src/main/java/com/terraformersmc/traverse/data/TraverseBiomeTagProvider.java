...
@NullMarked
public class TraverseBiomeTagProvider extends FabricTagsProvider<Biome> {
	protected TraverseBiomeTagProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
