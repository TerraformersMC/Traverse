...
public class TraverseFeatureConfigs {
	...
	public static final TreeFeatureConfig FIR_TREE_CONFIG = new TreeFeatureConfig.Builder(
			...
			//BlockStateProvider.of(TraverseBlocks.FIR_SAPLING.getDefaultState()),
	...
	private static TreeFeatureConfig oakLike(Block trunk, Block leaves, Block sapling, int height) {
		return new TreeFeatureConfig.Builder(
				...
				//BlockStateProvider.of(sapling.getDefaultState()),
	...
	static {
		{ // Lush Flower Config
			...
			LUSH_FLOWER_CONFIG = ConfiguredFeatures.createRandomPatchFeatureConfig(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(flowers), List.of(), 64);//.cannotProject().build();
		}
	}
