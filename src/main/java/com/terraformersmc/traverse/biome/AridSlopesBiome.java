...
public class AridSlopesBiome extends Biome {

	static final ConfiguredSurfaceBuilder SURFACE_BUILDER = new ConfiguredSurfaceBuilder<>(TraverseSurfaceBuilders.ARID_SLOPES, SurfaceBuilder.STONE_CONFIG);
	...
	public AridSlopesBiome() {
		...
		this.addSpawn(EntityCategory.CREATURE, new SpawnEntry(EntityType.COW, 5, 4, 4));
		this.addSpawn(EntityCategory.CREATURE, new SpawnEntry(EntityType.HORSE, 3, 2, 6));
		this.addSpawn(EntityCategory.CREATURE, new SpawnEntry(EntityType.DONKEY, 1, 1, 2));
		...
		this.addSpawn(EntityCategory.MONSTER, new SpawnEntry(EntityType.ZOMBIE, 85, 4, 4));
		this.addSpawn(EntityCategory.MONSTER, new SpawnEntry(EntityType.ZOMBIE_VILLAGER, 5, 1, 1));
		this.addSpawn(EntityCategory.MONSTER, new SpawnEntry(EntityType.HUSK, 10, 1, 5));
