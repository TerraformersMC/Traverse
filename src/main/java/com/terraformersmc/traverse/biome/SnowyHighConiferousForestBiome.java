...
public class SnowyHighConiferousForestBiome extends Biome {
    ...
    static final Precipitation PRECIPITATION = Precipitation.SNOW;
    static final Category CATEGORY = Category.FOREST;
    static final float DEPTH = 1.6F;
    static final float SCALE = 0.4F;
    static final float TEMPERATURE = -0.6F;
    ...
    public SnowyHighConiferousForestBiome() {
		...
		TraverseBiomeFeatures.addConiferousForestTrees(this);
