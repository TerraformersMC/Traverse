...
public class CliffsBiomes {
	static final Biome.Builder CLIFFS_TEMPLATE = new Biome.Builder()
			...
			.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, TraversePlacedFeatures.LOW_DIRT)
			.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, TraversePlacedFeatures.LOW_GRAVEL)
			.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, TraversePlacedFeatures.LOW_GRANITE)
			.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, TraversePlacedFeatures.LOW_DIORITE)
			.addFeature(GenerationStep.Feature.UNDERGROUND_ORES, TraversePlacedFeatures.LOW_ANDESITE)
