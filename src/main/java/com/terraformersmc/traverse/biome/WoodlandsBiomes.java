...
public class WoodlandsBiomes {
	public static Biome create(BootstrapContext<Biome> registerable) {
		return new Biome.BiomeBuilder()
				...
				.specialEffects(TraverseBiomes.createDefaultBiomeEffects()
						.grassColorOverride(0x99A955)
						.foliageColorOverride(0x849E4A)
						.build()
				)
	...
	private static BiomeGenerationSettings createGenerationSettings(BootstrapContext<Biome> registerable) {
		...
		builder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, placedFeatures.getOrThrow(TraversePlacedFeatures.WOODLANDS_TREES));
