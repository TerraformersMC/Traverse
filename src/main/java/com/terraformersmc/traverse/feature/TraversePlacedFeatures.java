...
public class TraversePlacedFeatures {
	...
	public static final RegistryEntry<PlacedFeature> OAK_SHRUB = createPlacedFeature("oak_shrub", TraverseConfiguredFeatures.OAK_SHRUB);
	...
	static final RegistryEntry<PlacedFeature> RED_AUTUMNAL_TREE = createPlacedFeature("red_autumnal_tree", TraverseConfiguredFeatures.RED_AUTUMNAL_TREE);
	static final RegistryEntry<PlacedFeature> ORANGE_AUTUMNAL_TREE = createPlacedFeature("orange_autumnal_tree", TraverseConfiguredFeatures.ORANGE_AUTUMNAL_TREE);
	static final RegistryEntry<PlacedFeature> YELLOW_AUTUMNAL_TREE = createPlacedFeature("yellow_autumnal_tree", TraverseConfiguredFeatures.YELLOW_AUTUMNAL_TREE);
	static final RegistryEntry<PlacedFeature> BROWN_AUTUMNAL_TREE = createPlacedFeature("brown_autumnal_tree", TraverseConfiguredFeatures.BROWN_AUTUMNAL_TREE);
	static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> AUTUMNAL_TREES_CONFIGURED = TraverseConfiguredFeatures.register("autumnal_trees",
