...
public class TraverseFeatures {
	...
	public static final TerraformOakTreeFeature BROWN_AUTUMNAL_TREE = add("brown_autumnal_tree", new TerraformOakTreeFeature(DefaultFeatureConfig::deserialize, false, 5, Blocks.OAK_LOG.getDefaultState(), TraverseBlocks.BROWN_AUTUMNAL_LEAVES.getDefaultState()));
	...
	public static final TerraformOakTreeFeature YELLOW_AUTUMNAL_TREE = add("yellow_autumnal_tree", new TerraformOakTreeFeature(DefaultFeatureConfig::deserialize, false, 6, Blocks.BIRCH_LOG.getDefaultState(), TraverseBlocks.YELLOW_AUTUMNAL_LEAVES.getDefaultState()));
