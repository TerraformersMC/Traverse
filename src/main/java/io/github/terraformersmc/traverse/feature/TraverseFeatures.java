package io.github.terraformersmc.traverse.feature;
...
public class TraverseFeatures {
    ...
    public static final MeadowFlowerFeature MEADOW_FLOWER = add("meadow_flower", new MeadowFlowerFeature(DefaultFeatureConfig::deserialize));
    public static final OakTreeFeature MINI_JUNGLE_TREE = add("meadow_flower", new OakTreeFeature(DefaultFeatureConfig::deserialize, false, 4, Blocks.JUNGLE_LOG.getDefaultState(), Blocks.JUNGLE_LEAVES.getDefaultState(), true));
