...
@NullMarked
public class TraverseBiomeTagsProvider extends FabricTagsProvider<Biome> {
	protected TraverseBiomeTagsProvider(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
